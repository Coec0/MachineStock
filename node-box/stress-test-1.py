...
def start_node_box(layer, input_size, processor_local, tag_local, file=None, tag_to_pos=None, verbosity=logging.WARNING):
...
start_node_box(1, layer_1_size, processor_final, ["final"], tag_to_pos=tag_to_pos_layer2, verbosity=logging.INFO)
